...
public class Digest {
    ...
    public Digest(String[] args, String callerName, String toolName) {
...
//        }
        ...
        digest(inputFilenamesList, optSet);
    ...
    private void digest(ArrayList<String> inputFilenamesList, OptSet optSet) {
//        
        Integer k = -1;
