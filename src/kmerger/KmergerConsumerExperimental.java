...
public class KmergerConsumerExperimental implements Runnable {
    ...
    private final ArrayList<BlockingQueue<ArrayList<String>>> inputQueues;
    ...
    public KmergerConsumerExperimental(ArrayList<BlockingQueue<ArrayList<String>>> inputQueue, BlockingQueue<ArrayList<String>> outputQueue, 
    ...
    public void run() {
//        try {
//            ListIterator inputQueuesListIterator = inputQueues.listIterator();
//            while(inputQueuesListIterator.hasNext())
