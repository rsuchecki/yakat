 ...
 */
public class PairMer5LongEncoded extends PairMer implements Comparable<PairMer5LongEncoded> {

    private long kmerCoreBits1;
    private long kmerCoreBits2;
    private long kmerCoreBits3;
    private long kmerCoreBits4;
    private long kmerCoreBits5;
     ...
     * @param rightClip
     */
    public PairMer5LongEncoded(char leftClip, String core, char rightClip, int freq) {
     ...
     * @param kmerCoreOnly
     */
    public PairMer5LongEncoded(String kmerCoreOnly) {
...
public final void addFirstKmer(char leftClip, String core, char rightClip, int freq) {
    ...
    public boolean equals(Object anotherKmer) {
        return compareTo((PairMer5LongEncoded) anotherKmer) == 0;
    }
    ...
    @Override
    public int compareTo(PairMer5LongEncoded anotherKmer) {
        return CoreCoder.compareCores(getBitFields(), anotherKmer.getBitFields());
    }
    
    public long[] getBitFields() {
        long bitsArray[] = {kmerCoreBits1, kmerCoreBits2, kmerCoreBits3, kmerCoreBits4, kmerCoreBits5}; 
        return bitsArray;
    }
    ...
    private void encodeCore(String kmerCoreOnly) {
        ...
        if(encodeCoreLong.length != 5) {
            ...
            kmerCoreBits5 = encodeCoreLong[4];
        }
