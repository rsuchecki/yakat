...
/**
 * Class for encoding/decoding PairMers (without the core) to a single byte filed
 *
 * @author Radoslaw Suchecki <radoslaw.suchecki@adelaide.edu.au>
 */
public class KmerExtByte {//implements Comparable<PairMer> {

    private byte encoded;
    //7 (sign) wasVisited: 0==false, 1==true
    //6,5,4    left clip:  \fi,A,C,G,T or X for extensions conflict
    //3,2,1    right clip: \fi,A,C,G,T or X for extensions conflict
    //0        non-unique hash, go to next array/map 
...
//    private byte allFields; //Store 

    public KmerExtByte(byte encoded) {
     ...
     */
    public synchronized void addKmerSynchronized(KmerExtByte another, boolean inputKmersUnique) {
