 ...
 */
public class PairMer1LongEncoded_OLD extends PairMer implements Comparable<PairMer1LongEncoded_OLD> {
     ...
     * @param rightClip
     */
    public PairMer1LongEncoded_OLD(char leftClip, String core, char rightClip, int freq) {
     ...
     * @param kmerCoreOnly
     */
    public PairMer1LongEncoded_OLD(String kmerCoreOnly) {
...
//    }
    ...
    public boolean equals(Object anotherKmer) {
        return compareTo((PairMer1LongEncoded_OLD) anotherKmer) == 0;
    }
...
//        return hash;
    ...
    @Override
    public int compareTo(PairMer1LongEncoded_OLD anotherKmer) {
