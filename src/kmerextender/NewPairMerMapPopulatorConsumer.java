...
//    private long pairMersGenerated;
    ...
    public NewPairMerMapPopulatorConsumer(BlockingQueue<List<String>> queue, NewPairMerArrays pairMerArrays,
...
//        pairMersMaps.addToTotalPairMersGenerated(pairMersGenerated);
    ...
    private boolean addKmerToMap(CharSequence inputKmerSequence, int freq) {
        try {
//            System.err.println("");
