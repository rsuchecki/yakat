 ...
 */
public class SplitterConsumer implements Runnable {
...
//    private final String OUT_LABEL;
    ...
    public SplitterConsumer(BlockingQueue<ArrayList<String>> inputQueue,
    ...
    public void run() {
        try {
                ...
                for (String line : list) {
                    ...
                    for (Map.Entry<String, String> entrySet : barcodes.entrySet()) {
                        ...
                        if (sequence.startsWith(barcode)) {
                            ...
                            if (bufferList == null) {
                                bufferList = new ArrayList<>(KMER_BUFFER_SIZE);
            ...
            for (String sample : keySet) {
                ...
                outQ.add(new ArrayList<String>());//inform other threads
            }
