...
//    }
     ...
     * MSA. All terminal dashes are treated as padding. Internal dashes are treated as padding 
     * if a stretch is longer then maxIndelLength or it violates  minIndelDistFromEnds, 
     * otherwise a stretch is treated as indel
     *
    ...
    private void generatePaddingArray(int maxIndelLength, int minIndelDistFromEnds) {
