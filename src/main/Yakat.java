...
//        System.out.println("java -jar " + this.getClass().getSimpleName().toLowerCase() + "-" + version + ".jar <command> ");
        System.out.println("Usage: java -jar " + this.getClass().getSimpleName().toLowerCase()+".jar <command> ");
        ...
        System.out.println("    snpmers       : given parental SNPs and the corresponding FASTA sequences (e.g. from LNISKS), call offspring genotypes by overlapping their k-mers with parental SNP sequences ");
